...
var ChatForm = /*#__PURE__*/function () {
  function ChatForm(formSel, inputSel) {
    ...
    this.$form = jquery__WEBPACK_IMPORTED_MODULE_0___default()(formSel);
    this.$input = jquery__WEBPACK_IMPORTED_MODULE_0___default()(inputSel);
  }
...
var ChatList = /*#__PURE__*/function () {
  function ChatList(listSel, username) {
    ...
    this.$list = jquery__WEBPACK_IMPORTED_MODULE_0___default()(listSel);
  ...
  _createClass(ChatList, [{
    ...
    value: function drawMessage(_ref) {
      var u = _ref.user,
          t = _ref.timestamp,
          m = _ref.message;
      var $messageRow = jquery__WEBPACK_IMPORTED_MODULE_0___default()('<li>', {
        'class': 'message-row'
      });
      ...
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(this.$list).append($messageRow);
